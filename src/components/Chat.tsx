...
const Chat: React.FC<ChatProps> = ({ onBack, currentUser, otherUser, messages }) => {
    ...
    const lastMissionMessage = [...messages].reverse().find(msg => msg.missionTitle);
                    ...
                    {lastMissionMessage && (
                        <div className="p-4 bg-blue-50 border-b border-gray-200">
                            <div className="flex items-center space-x-2 text-sm text-blue-800">
                                ...
                                <span>{lastMissionMessage.missionTitle}</span>
                            </div>
                            <div className="text-xs text-blue-600 mt-1">
                                Status: {lastMissionMessage.missionStatus} • {lastMissionMessage.missionLocation}
                            </div>
                        </div>
                    )}
